...
},
{
  ...
  "number": "1.3.7",
  "title": "",
  "body": "  Suppose that is a group and that is a commutative ring. Then, is an -algebra, and it is a free -module with basis .  Let be an -algebra, and let be a homomorphism to the multiplicative monoid of . Then, extends uniquely to an -algebra homomorphism of -algebras.  In other words, the following diagram commutes.    "
},
{
...
},
{
  ...
  "body": " Factorization criterion   Let be a commutative ring with unity. Let and be homomorphisms of -algebras with surjective. Show that factors through i.e., there exists a homomorphism of -algebras such that if and only if .   In other words, there exists a dotted arrow ( -algebra homomorphism ) making the above diagram commutative if and only if .   "
},
{
...
},
{
  ...
  "body": " Simple modules   We define simple modules and study some of their properties. We begin with the definition of cyclic module . Throughout this section, we assume that is a commutative ring with unity, and that is an -algebra. All modules are considered to be right -modules.    Cyclic module   Let be an -algebra and be a right -module. We say that is a cyclic module if there exists such that .      Let be an -algebra and be a right -module which is cyclic. Then,    .    If is a right ideal of then, is a cyclic right -module.    Let be a right ideal of . Put . Then, is a subalgebra of containing .            Suppose that . Define a map by . As is cyclic, the map is surjective and its kernel is precisely . The first isomorphism theorem for modules gives the required isomorphism.    Checking is a right -module is left to the reader. Consider the submodule of generated by . Given any we have , and therefore, .    We first check that is a subalgebra of containing . For , , and we have As is a right ideal of and hence . This shows that . We leave to the reader to check other conditions for to be a subalgebra of .            Every cyclic group is a cyclic -module.    Suppose that be an -linear map defined by and . We consider as a module over via . Note that but . In fact and hence, is a basis of . This shows that is a cyclic -module generated by . By , we have .    Let be an -algebra. Consider as a right -module over itself. Then, the cyclic submodules of are precisely the right principal ideal of .        Simple module   Let be a commutative ring with unity, and be an -algebra. A right -module is said to be simple if is nonzero and only submodules of are and itself.     One-dimensional subspaces over division algebra as simple modules   Assume that is a division algebra over a field . Let be a right -module, and let be a nonzero element. The cyclic submodule generated by is simple. Indeed, if we take any , i.e., then, . Hence, for any nonzero .     Cyclic module need not be simple   Consider as a -module. The cyclic submodule generated by is not simple. Indeed, for every , .     Minimal right ideal of matrix algebra   Suppose that is a division algebra over a field , and that is matrix algebra over . Consider the following set. The is a right ideal of . We consider as a right -module. We claim that is a simple right -module. Suppose that , say . As is a division algebra, there exists such that . Assume that to be the matrix with -th entry and all other entries . Note that we have For any we have and . Hence, . Therefore, , i.e., is a simple right -module.  The above arguments show that is a minimal right ideal of , and that for any we have -module isomorphism . Furthermore, if we denote by as the set of matrices in whose only nonzero row can be the -th row, then each is a minimal right ideal of . Note that . One may also check that for every .      Let be a nonzero right -module. Following conditions are equivalent.   The module is simple;    For any nonzero , ;    The module for some maximal right ideal of .        Assume that is simple and that is nonzero. Thus, the submodule generated by , is a nonzero submodule of . Thus, . Conversely, if for any nonzero element then, for any nonzero submodule and , we have , i.e., , i.e., is simple.  We fix a nonzero element and define a map by . This is a surjective -module homomorphism. The kernel of is By , is a right ideal of . By the isomorphism theorem, . By the Correspondence theorem, submodules of corresponds to right ideals of containing . Thus, is simple if and only if there are no proper right ideals of containing . This proves the equivalence of (1) and (3).   Using the above we obtain the following important lemma. Details of the proof is left to the reader.   Schur's lemma - version 1   Let and be right -modules, and be a nonzero -module homomorphism.   If is simple then, is injective.    If is simple then, is surjective.         If and are simple -modules then either or .     Semisimple module   A right -module is said to be semisimple if is a direct sum of simple -modules.     Matrix algebra is semisimple   We have shown in that is a semisimple -module.     Indecomposable module   A right -module is said to be indecomposable if and that if for some submodules then, either or .     Indecomposable module need not be simple   Every simple -module is indecomposable. However, the converse need not be true, as shown below.  Consider as a -module. As the subgroup generated by is a proper nontrivial submodule of , we conclude that is not simple. Recall that there are, up to isomorphism, only two groups of order , viz., and . This shows that is indecomposable.     Schur's lemma - version 2   Let be a semisimple right -module. The following conditions are equivalent.   The module is simple;     is division algebra;    The module is indecomposable.        Assume that is simple. By , every nonzero -module endomorphism is invertible, i.e., is division.  Assume that is division algebra, and that for some -submodules of . The propjection (resp., ) is an -module homomorphism. As and is division either or . Hence, either or .  If is semisimple indecomposable module, then has to be simple (follows from definitions of semisimple and indecomposable modules).   "
},
{
...
},
{
  ...
  "number": "3.2.2",
  "title": "",
  "body": "  Let be an -algebra and be a right -module which is cyclic. Then,    .    If is a right ideal of then, is a cyclic right -module.    Let be a right ideal of . Put . Then, is a subalgebra of containing .       "
},
{
  ...
  "number": "3.2.1",
  "title": "",
  "body": "    Suppose that . Define a map by . As is cyclic, the map is surjective and its kernel is precisely . The first isomorphism theorem for modules gives the required isomorphism.    Checking is a right -module is left to the reader. Consider the submodule of generated by . Given any we have , and therefore, .    We first check that is a subalgebra of containing . For , , and we have As is a right ideal of and hence . This shows that . We leave to the reader to check other conditions for to be a subalgebra of .      "
},
{
  "id": "sec-simple-modules-6",
  "level": "2",
  "url": "sec-simple-modules.html#sec-simple-modules-6",
  "type": "Example",
  "number": "3.2.3",
  "title": "",
  "body": "     Every cyclic group is a cyclic -module.    Suppose that be an -linear map defined by and . We consider as a module over via . Note that but . In fact and hence, is a basis of . This shows that is a cyclic -module generated by . By , we have .    Let be an -algebra. Consider as a right -module over itself. Then, the cyclic submodules of are precisely the right principal ideal of .      "
},
{
  ...
  "number": "3.2.4",
  "title": "Simple module.",
  "body": " Simple module   Let be a commutative ring with unity, and be an -algebra. A right -module is said to be simple if is nonzero and only submodules of are and itself.   "
},
{
  "id": "one-dim-subspaces-as-simple-modules",
  "level": "2",
  "url": "sec-simple-modules.html#one-dim-subspaces-as-simple-modules",
  "type": "Example",
  "number": "3.2.5",
  "title": "One-dimensional subspaces over division algebra as simple modules.",
  "body": " One-dimensional subspaces over division algebra as simple modules   Assume that is a division algebra over a field . Let be a right -module, and let be a nonzero element. The cyclic submodule generated by is simple. Indeed, if we take any , i.e., then, . Hence, for any nonzero .   "
},
{
  "id": "sec-simple-modules-9",
  "level": "2",
  "url": "sec-simple-modules.html#sec-simple-modules-9",
  "type": "Example",
  "number": "3.2.6",
  "title": "Cyclic module need not be simple.",
  "body": " Cyclic module need not be simple   Consider as a -module. The cyclic submodule generated by is not simple. Indeed, for every , .   "
},
{
  "id": "ex-minimal-right-ideal-of-matrix-algebra",
  "level": "2",
  "url": "sec-simple-modules.html#ex-minimal-right-ideal-of-matrix-algebra",
  "type": "Example",
  "number": "3.2.7",
  "title": "Minimal right ideal of matrix algebra.",
  "body": " Minimal right ideal of matrix algebra   Suppose that is a division algebra over a field , and that is matrix algebra over . Consider the following set. The is a right ideal of . We consider as a right -module. We claim that is a simple right -module. Suppose that , say . As is a division algebra, there exists such that . Assume that to be the matrix with -th entry and all other entries . Note that we have For any we have and . Hence, . Therefore, , i.e., is a simple right -module.  The above arguments show that is a minimal right ideal of , and that for any we have -module isomorphism . Furthermore, if we denote by as the set of matrices in whose only nonzero row can be the -th row, then each is a minimal right ideal of . Note that . One may also check that for every .   "
},
{
  "id": "prop-equivalent-criterion-for-simple-modules",
  "level": "2",
  "url": "sec-simple-modules.html#prop-equivalent-criterion-for-simple-modules",
  "type": "Proposition",
  "number": "3.2.8",
  "title": "",
  "body": "  Let be a nonzero right -module. Following conditions are equivalent.   The module is simple;    For any nonzero , ;    The module for some maximal right ideal of .      "
},
{
  "id": "sec-simple-modules-12",
  "level": "2",
  "url": "sec-simple-modules.html#sec-simple-modules-12",
  "type": "Proof",
  "number": "3.2.2",
  "title": "",
  "body": " Assume that is simple and that is nonzero. Thus, the submodule generated by , is a nonzero submodule of . Thus, . Conversely, if for any nonzero element then, for any nonzero submodule and , we have , i.e., , i.e., is simple.  We fix a nonzero element and define a map by . This is a surjective -module homomorphism. The kernel of is By , is a right ideal of . By the isomorphism theorem, . By the Correspondence theorem, submodules of corresponds to right ideals of containing . Thus, is simple if and only if there are no proper right ideals of containing . This proves the equivalence of (1) and (3).  "
},
{
  "id": "lem-schur-lemma",
  "level": "2",
  "url": "sec-simple-modules.html#lem-schur-lemma",
  "type": "Lemma",
  "number": "3.2.9",
  "title": "Schur’s lemma - version 1.",
  "body": " Schur's lemma - version 1   Let and be right -modules, and be a nonzero -module homomorphism.   If is simple then, is injective.    If is simple then, is surjective.      "
},
{
  "id": "cor-schur-lemma",
  "level": "2",
  "url": "sec-simple-modules.html#cor-schur-lemma",
  "type": "Corollary",
  "number": "3.2.10",
  "title": "",
  "body": "  If and are simple -modules then either or .   "
},
{
  "id": "def-semisimple-module",
  "level": "2",
  "url": "sec-simple-modules.html#def-semisimple-module",
  "type": "Definition",
  "number": "3.2.11",
  "title": "Semisimple module.",
  "body": " Semisimple module   A right -module is said to be semisimple if is a direct sum of simple -modules.   "
},
{
  "id": "ex-matrix-algebra-is-semisimple",
  "level": "2",
  "url": "sec-simple-modules.html#ex-matrix-algebra-is-semisimple",
  "type": "Example",
  "number": "3.2.12",
  "title": "Matrix algebra is semisimple.",
  "body": " Matrix algebra is semisimple   We have shown in that is a semisimple -module.   "
},
{
  "id": "def-indecomposable-module",
  "level": "2",
  "url": "sec-simple-modules.html#def-indecomposable-module",
  "type": "Definition",
  "number": "3.2.13",
  "title": "Indecomposable module.",
  "body": " Indecomposable module   A right -module is said to be indecomposable if and that if for some submodules then, either or .   "
},
{
  "id": "ex-indecomposable-need-not-imply-simple",
  "level": "2",
  "url": "sec-simple-modules.html#ex-indecomposable-need-not-imply-simple",
  "type": "Example",
  "number": "3.2.14",
  "title": "Indecomposable module need not be simple.",
  "body": " Indecomposable module need not be simple   Every simple -module is indecomposable. However, the converse need not be true, as shown below.  Consider as a -module. As the subgroup generated by is a proper nontrivial submodule of , we conclude that is not simple. Recall that there are, up to isomorphism, only two groups of order , viz., and . This shows that is indecomposable.   "
},
{
  "id": "prop-schur-lemma-indecomposable",
  "level": "2",
  "url": "sec-simple-modules.html#prop-schur-lemma-indecomposable",
  "type": "Proposition",
  "number": "3.2.15",
  "title": "Schur’s lemma -  version 2.",
  "body": " Schur's lemma - version 2   Let be a semisimple right -module. The following conditions are equivalent.   The module is simple;     is division algebra;    The module is indecomposable.      "
},
{
  "id": "sec-simple-modules-21",
  "level": "2",
  "url": "sec-simple-modules.html#sec-simple-modules-21",
  "type": "Proof",
  "number": "3.2.3",
  "title": "",
  "body": " Assume that is simple. By , every nonzero -module endomorphism is invertible, i.e., is division.  Assume that is division algebra, and that for some -submodules of . The propjection (resp., ) is an -module homomorphism. As and is division either or . Hence, either or .  If is semisimple indecomposable module, then has to be simple (follows from definitions of semisimple and indecomposable modules).  "
},
{
  "id": "ws-simple-modules",
  "level": "1",
  "url": "ws-simple-modules.html",
  "type": "Worksheet",
  "number": "3.3",
...
},
{
  ...
  "level": "2",
  "url": "ws-simple-modules.html#ws-simple-modules-3-2",
  "type": "Worksheet Exercise",
  "number": "3.3.1",
  "title": "",
  "body": "   and ;   "
...
{
  "id": "ws-simple-modules-3-3",
  "level": "2",
  "url": "ws-simple-modules.html#ws-simple-modules-3-3",
  "type": "Worksheet Exercise",
  "number": "3.3.2",
  "title": "",
  "body": "   and ;   "
...
{
  "id": "ws-simple-modules-3-4",
  "level": "2",
  "url": "ws-simple-modules.html#ws-simple-modules-3-4",
  "type": "Worksheet Exercise",
  "number": "3.3.3",
  "title": "",
  "body": "   , an -algebra of continuous real valued functions on ;   "
},
{
  "id": "ws-simple-modules-3-5",
  "level": "2",
  "url": "ws-simple-modules.html#ws-simple-modules-3-5",
  "type": "Worksheet Exercise",
  "number": "3.3.4",
  "title": "",
  "body": "   for any field .   "
...
{
  "id": "prop-universal-property-of-direct-sum",
  "level": "2",
...
},
{
  ...
  "body": " Noetherian Module   An -module is said to be Noetherian if there are no infinite, strictly increasing sequences of submodules of , i.e., if is an increasing chain of -submodules of then, there exists such that for all .   "
},
{
...
{
  "id": "cor-artinian-module-has-simple-submodule",
  "level": "2",
  "url": "sec-chain-conditions.html#cor-artinian-module-has-simple-submodule",
  "type": "Corollary",
  "number": "3.6.4",
  "title": "Existence of a simple submodule of a nonzero Artinian module.",
  "body": " Existence of a simple submodule of a nonzero Artinian module   Let be a nonzero Artinian -module. Then, has a simple -submodule.   "
},
{
  "id": "sec-chain-conditions-8",
  "level": "2",
  "url": "sec-chain-conditions.html#sec-chain-conditions-8",
  "type": "Proof",
  "number": "3.6.1",
  "title": "",
  "body": " Consider the set of all nonzero -submodules of . As , the set . By , there exists a minimal element, say . By the minimality of , only submodules of are and itself. Thus, it is a simple -submodule.  "
},
{
...
},
{
  ...
  "body": " Artinian but not Noetherian   If we consider as a -module then, it is Artinian but not Noetherian.   "
},
{
...
{
  "id": "sec-chain-conditions-15",
  "level": "2",
  "url": "sec-chain-conditions.html#sec-chain-conditions-15",
  "type": "Proof",
  "number": "3.6.2",
  "title": "",
...
{
  "id": "sec-chain-conditions-20",
  "level": "2",
  "url": "sec-chain-conditions.html#sec-chain-conditions-20",
  "type": "Proof",
  "number": "3.6.4",
  "title": "",
  "body": " We have proved in that if is both Artinian and Noetherian then, has a composition series. Converse follows from .  "
},
{
...
{
  "id": "sec-chain-conditions-23",
  "level": "2",
  "url": "sec-chain-conditions.html#sec-chain-conditions-23",
  "type": "Proof",
  "number": "3.6.5",
  "title": "",
  "body": " As is both Artinian and Noetherian, modules and are Artinian and Noetherian as well (see ). Hence, and have composition series. We consider as a submodule of using the injection . Let and be composition series of and respectively. As is a simple module and it is isomorphic to for , we have the following composition series of . By , we get .  "
},
{
  "id": "thm-semisimple-artinian-noetherian-modules",
  "level": "2",
...
{
  "id": "sec-chain-conditions-26",
  "level": "2",
  "url": "sec-chain-conditions.html#sec-chain-conditions-26",
  "type": "Proof",
  "number": "3.6.6",
  "title": "",
...
{
  "id": "ex-fininitely-generated-but-not-artinian",
  "level": "2",
...
{
  "id": "ex-endomorphism-artinian-noetherian",
  "level": "2",
  "url": "ws-artinian-noetherian.html#ex-endomorphism-artinian-noetherian",
  "type": "Worksheet Exercise",
  "number": "3.7.2",
  "title": "",
...
},
{
  ...
  "number": "3.7.4",
  "title": "",
  "body": "  Let be a right Artinian (resp., Noetherian) -module. Show that if for some positive integers , then .  Recall that denotes the direct sum of -copies of .    We may assume that and that is Noetherian. Consider the projection homomorphism , and suppose that is the given isomorphism. Consider the endomorphism . As and are surjective, so is . Using , we conclude that is an isomorphism. In particular, is an isomorphism onto its image, which is impossible if .   "
},
{
  "id": "ws-artinian-noetherian-7",
  "level": "2",
  "url": "ws-artinian-noetherian.html#ws-artinian-noetherian-7",
  "type": "Worksheet Exercise",
  "number": "3.7.5",
  "title": "",
...
{
  "id": "ws-artinian-noetherian-10",
  "level": "2",
  "url": "ws-artinian-noetherian.html#ws-artinian-noetherian-10",
  "type": "Worksheet Exercise",
  "number": "3.7.8",
  "title": "",
...
{
  "id": "def-socle-of-module",
  "level": "2",
  "url": "sec-radical.html#def-socle-of-module",
  "type": "Definition",
  "number": "3.8.6",
...
{
  "id": "ex-socle-and-radical-of-polynomial-module",
  "level": "2",
  "url": "sec-radical.html#ex-socle-and-radical-of-polynomial-module",
  "type": "Example",
  "number": "3.8.8",
  "title": "Socle and radical of <span class=\"process-math\">\\(\\R[x]\/(x^n)\\)<\/span> as an <span class=\"process-math\">\\(\\R[x]\\)<\/span>-module.",
  "body": " Socle and radical of as an -module   Let be an -module. We calculate the socle and the radical of . By the correspondence theorem, submodules of are submodules of containing . Note that the only such submodules are , , and . Thus, the only proper nontrivial submodule of is . As is simple, we have . Also, is the only simple submodule of and hence, .  More generally, for , let be an -module. Then, by similar arguments as above, we have and .   "
},
{
  "id": "ex-socle-and-radical-of-integral-domain-module",
  "level": "2",
  "url": "sec-radical.html#ex-socle-and-radical-of-integral-domain-module",
  "type": "Example",
  "number": "3.8.9",
  "title": "Socle and radical of an integral domain which is not a field.",
  "body": " Socle and radical of an integral domain which is not a field   Let be an integral domain which is not a field. Consider as a right -module. So, the simple -modules are nonzero minimal ideals of . As every ideal is contained in a maximal and hence a prime ideal, we need to find nonzero minimal prime ideals of . However, there are no nonzero minimal prime ideals in an integral domain which is not a field.  Why there are no nonzero minimal prime ideals in an integral domain which is not a field?  Let be a nonzero minimal prime ideal of . Consider . As is the unique prime ideal of , we have , i.e., there exists such that . As is an integral domain, .  Hence, and .  If is a field then, as an -module, and . In fact for any vector space over , and .   "
},
{
...
},
{
  "id": "sec-radical-16",
  "level": "2",
  "url": "sec-radical.html#sec-radical-16",
  "type": "Proof",
  "number": "3.8.3",
  "title": "",
...
{
  "id": "note-essential-submodule-is-nonzero",
  "level": "2",
...
{
  "id": "lem-socle-as-intersection-of-essential-submodules",
  "level": "2",
...
},
{
  ...
  "number": "3.8.4",
  "title": "",
  "body": " For a simple submodule and a nonzero , we have . Thus, if is an essential submodule then, and hence, . This shows that is contained in every essential submodule of .  Conversely, let be the intersection of all essential -submodules of . We show that is semisimple by showing that any submodule of has a complement in . Let . Consider the following collection of submodules of . As , the collection . Suppose that is a chain in . We show that . Indeed, if then, for some . Thus, as . By Zorn's lemma, there exists a maximal element in . We claim that is an essential submodule of . Suppose not, then there exists a nonzero submodule such that . If there exists then, for and . Thus, . This shows that and hence, , contradicting the maximality of . Thus, is an essential submodule of and hence, it contains . This shows that . As we have . Therefore, every submodule of has a complement in and hence, is semisimple (see ). This shows that .  "
},
{
  "id": "lem-socle-of-artinian-module-is-essential",
  "level": "2",
...
},
{
  ...
  "number": "3.8.5",
  "title": "",
  "body": " Let be a nonzero -submodule. As is Artinian, so is . Therefore, has a simple submodule, say (see ). By definition of socle, and hence, .  "
},
{
  "id": "cor-injectivity-for-socle-of-artinian-module",
  "level": "2",
...
},
{
  "id": "sec-radical-24",
  "level": "2",
  "url": "sec-radical.html#sec-radical-24",
  "type": "Proof",
  "number": "3.8.6",
  "title": "",
...
},
{
  ...
  "number": "4.1.4",
  "title": "",
  "body": "  If is a semisimple algebra, then every right -module is semisimple. Furthermore, simple right -modules are, up to isomorphism, precisely the minimal right ideals of .   "
},
{
...
},
{
  ...
  "number": "4.1.5",
  "title": "",
  "body": "  Let and be -algebras with semisimple. If is a surjective -algebra homomorphism, then is semisimple algebra.   "
},
{
...
{
  "id": "cor-number-of-isomorphism-classes-of-simple-A-modules",
  "level": "2",
...
{
  "id": "ws-minimal-right-ideals",
  "level": "1",
  "url": "ws-minimal-right-ideals.html",
  "type": "Worksheet",
  "number": "4.4",
  "title": "Exercises related to minimal right ideals",
  "body": " Exercises related to minimal right ideals   Most of the exercises are taken from . We assume that is a commutative ring with unity, and is an -algebra.     Let be a semisimple algebra such that with simple algebras. Show that if (resp., ) is a minimal right ideal of (resp., ) for then, . In particular, .      An element of an -algebra is said to be idempotent if . Prove the following statements.   The algebra is semisimple if and only if every right ideal of is of the form for some idempotent .    If is semisimple and then, .    If is semisimple and is a two-sided ideal of then, there is a unique central idempotent such that . Conversely, show that if is an idempotent then, is a two-sided ideal of .    Let be central idempotents such that and for . Then, show that .       "
},
{
  "id": "ws-minimal-right-ideals-3",
  "level": "2",
  "url": "ws-minimal-right-ideals.html#ws-minimal-right-ideals-3",
  "type": "Worksheet Exercise",
  "number": "4.4.1",
  "title": "",
  "body": "  Let be a semisimple algebra such that with simple algebras. Show that if (resp., ) is a minimal right ideal of (resp., ) for then, . In particular, .   "
},
{
  "id": "ws-minimal-right-ideals-4",
  "level": "2",
  "url": "ws-minimal-right-ideals.html#ws-minimal-right-ideals-4",
  "type": "Worksheet Exercise",
  "number": "4.4.2",
  "title": "",
  "body": "  An element of an -algebra is said to be idempotent if . Prove the following statements.   The algebra is semisimple if and only if every right ideal of is of the form for some idempotent .    If is semisimple and then, .    If is semisimple and is a two-sided ideal of then, there is a unique central idempotent such that . Conversely, show that if is an idempotent then, is a two-sided ideal of .    Let be central idempotents such that and for . Then, show that .      "
},
{
  ...
  "body": " Simple algebras   We introduce simple algebras in this section. Although the term semisimple algebra , introduced earlier, suggests that it is a generalization of simple algebra, it is not true without some additional conditions.  We assume that is a commutative ring with unity and is an -algebra.    Simple algebra   An -algebra is said to be simple if its only two-sided ideals are and itself.     Quaternion algebra is simple over a field of characteristic not   We have shown in that the quaternion algebra over a field of characteristic not equal to is a simple algebra.    In the next propostion we characterize simple algebras that are semisimple.    For a simple algebra , following are equivalent:    is semisimple;     is right Artinian;     has a minimal right ideal.        Suppose that is a simple algebra as well as a semisimple algebra. We show that is right Artinian. Note that for any nonzero , the two-sided ideal is nonzero and hence, . Therefore, there are such that . This implies that is generated by , i.e., is finitely generated. In view of , is right Artinian. This shows that (1) implies (2).  If is right Artinian then, by , has a minimal right ideal. This shows that (2) implies (3).  Now assume that is a minimal right ideal of . Hence, and , a two-sided ideal of generated by , is . Thus, Note that each is a right ideal of , i.e., each is an -module. Furthermore, each as an -modules. Hence, is written as a sum of simple -modules, i.e., is a semisimple algebra. This proves that (3) implies (1).     Following statements are equivalent for a semisimple algebra :    is simple;    any two minimal right ideals of are isomorphic;    any two simple -modules are isomorphic.        Suppose that is simple. Let and are minimal right ideals of . Thus, and are nonzero ideals of . As is simple, we have . Therefore, In particular, . By , . This shows that (1) implies (2).  In view of , (2) and (3) are equivalent.  Assume now that any two minimal right ideals of are isomorphic. We show that is simple. Let be a nonzero proper two-sided ideal of . As is semisimple, so is as an -module. Hence, there is a simple -submodule . Note that by , is a minimal right ideal of . By the assumption, any two minimal right ideals are isomorphic. Hence, for a minimal right ideal there exists with (see ). Therefore, . This proves (2) implies (1).   We require the following propostion regarding uniqueness of direct sum representation of semisimple modules.  Suppose that be a set of representatives of the isomorphism classes of simple -modules. We denote by the submodule of a right -module .    Let and are semisimple right -modules. Suppose that with and that with . Then, if and only if the cardinal numbers and are equal for all .      Let be a simple algebra and let be a minimal right ideal of . If is a right -module then there exists a unique cardinal number such that .     As simple algebra has a minimal right ideal, is semisimple by . So, as a right module over a semisimple algebra, is semisimple module (see ). Therefore, is a direct sum of simple -modules. However, implies that any two simple -modules are isomorphic, i.e., . The uniqueness of follows from .     Let be a field and be a finite-dimensional simple -algbera. Suppose that and are right -modules. Then, if and only if .     As is an -algebra and are -modules, we can consider as an -modules (see ), i.e., are -vector spaces. As is finite-dimensional vector space over , it is both Artinian and Noetherian, and thus is semisimple (see ). By , are semisimple -modules. By , for unique cardinal numbers and a minimal right ideal of . By , if and only if . As , if and only .   One may revisit the .    We keep notation of . We let . Show that .    "
},
{
...
{
  "id": "prop-semisimple-simple-iff-minimal-right-ideals-are-isomorphic",
  "level": "2",
  "url": "sec-simple-algebras.html#prop-semisimple-simple-iff-minimal-right-ideals-are-isomorphic",
  "type": "Proposition",
  "number": "4.5.4",
  "title": "",
  "body": "  Following statements are equivalent for a semisimple algebra :    is simple;    any two minimal right ideals of are isomorphic;    any two simple -modules are isomorphic.      "
},
{
  "id": "sec-simple-algebras-9",
  "level": "2",
  "url": "sec-simple-algebras.html#sec-simple-algebras-9",
  "type": "Proof",
  "number": "4.5.2",
  "title": "",
  "body": " Suppose that is simple. Let and are minimal right ideals of . Thus, and are nonzero ideals of . As is simple, we have . Therefore, In particular, . By , . This shows that (1) implies (2).  In view of , (2) and (3) are equivalent.  Assume now that any two minimal right ideals of are isomorphic. We show that is simple. Let be a nonzero proper two-sided ideal of . As is semisimple, so is as an -module. Hence, there is a simple -submodule . Note that by , is a minimal right ideal of . By the assumption, any two minimal right ideals are isomorphic. Hence, for a minimal right ideal there exists with (see ). Therefore, . This proves (2) implies (1).  "
},
{
  "id": "prop-uniqueness-of-direct-sum-in-semisimple-module",
  "level": "2",
  "url": "sec-simple-algebras.html#prop-uniqueness-of-direct-sum-in-semisimple-module",
  "type": "Proposition",
  "number": "4.5.5",
  "title": "",
  "body": "  Let and are semisimple right -modules. Suppose that with and that with . Then, if and only if the cardinal numbers and are equal for all .   "
},
{
  "id": "cor-module-decomposition-over-simple-algebra",
  "level": "2",
  "url": "sec-simple-algebras.html#cor-module-decomposition-over-simple-algebra",
  "type": "Corollary",
  "number": "4.5.6",
  "title": "",
  "body": "  Let be a simple algebra and let be a minimal right ideal of . If is a right -module then there exists a unique cardinal number such that .   "
},
{
  "id": "sec-simple-algebras-14",
  "level": "2",
  "url": "sec-simple-algebras.html#sec-simple-algebras-14",
  "type": "Proof",
  "number": "4.5.3",
  "title": "",
  "body": " As simple algebra has a minimal right ideal, is semisimple by . So, as a right module over a semisimple algebra, is semisimple module (see ). Therefore, is a direct sum of simple -modules. However, implies that any two simple -modules are isomorphic, i.e., . The uniqueness of follows from .  "
},
{
  "id": "cor-modules-over-finite-dim-simple-algebra",
  "level": "2",
  "url": "sec-simple-algebras.html#cor-modules-over-finite-dim-simple-algebra",
  "type": "Corollary",
  "number": "4.5.7",
  "title": "",
  "body": "  Let be a field and be a finite-dimensional simple -algbera. Suppose that and are right -modules. Then, if and only if .   "
},
{
  "id": "sec-simple-algebras-16",
  "level": "2",
  "url": "sec-simple-algebras.html#sec-simple-algebras-16",
  "type": "Proof",
  "number": "4.5.4",
  "title": "",
  "body": " As is an -algebra and are -modules, we can consider as an -modules (see ), i.e., are -vector spaces. As is finite-dimensional vector space over , it is both Artinian and Noetherian, and thus is semisimple (see ). By , are semisimple -modules. By , for unique cardinal numbers and a minimal right ideal of . By , if and only if . As , if and only .  "
},
{
  "id": "endomorphisms-of-minimal-right-ideal-as-division-algebra",
  "level": "2",
  "url": "sec-simple-algebras.html#endomorphisms-of-minimal-right-ideal-as-division-algebra",
  "type": "Checkpoint",
  "number": "4.5.8",
  "title": "",
...
{
  "id": "cor-simple-algebra-as-matrix-over-division-algebra",
  "level": "2",
...
{
  "id": "cor-finite-dim-semisimple-algebra-over-algebraically-closed-field",
  "level": "2",
...
},
{
  ...
  "number": "4.9.3",
  "title": "",
  "body": "  Let be a semisimple algebra. Show that if is a finite generated -module then, is semisimple.   "
},
{
  "id": "backmatter-2",
  "level": "1",
