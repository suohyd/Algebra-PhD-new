...
{
  "id": "sec-simple-modules-10",
  "level": "2",
  "url": "sec-simple-modules.html#sec-simple-modules-10",
  "type": "Proof",
  "number": "3.2.2",
  "title": "",
...
},
{
  ...
  "number": "3.2.7",
  "title": "Schur’s lemma.",
  "body": " Schur's lemma   Let and be right -modules, and be a nonzero -module homomorphism.   If is simple then, is injective.    If is simple then, is surjective.      "
},
{
  "id": "cor-schur-lemma",
  "level": "2",
...
},
{
  ...
  "number": "3.2.13",
  "title": "",
  "body": "  Let be a semisimple right -module. The following conditions are equivalent.   The module is simple;     is division algebra;    The module is indecomposable.      "
},
{
  "id": "sec-simple-modules-19",
  "level": "2",
  "url": "sec-simple-modules.html#sec-simple-modules-19",
  "type": "Proof",
  "number": "3.2.3",
  "title": "",
  "body": " Let is simple. By , every nonzero -module endomorphism is invertible, i.e., is division.  Assume that is division algebra, and that for some -submodules of . The propjection (resp., \\unit_N-\\pi\\colon N\\to Q) is an -module homomorphism.  "
},
{
  "id": "backmatter-2",
  "level": "1",
