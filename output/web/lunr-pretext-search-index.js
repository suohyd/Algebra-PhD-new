...
},
{
  ...
  "type": "Example",
  "number": "3.8.8",
  "title": "Socle and radical of <span class=\"process-math\">\\(\\R[x]\/(x^n)\\)<\/span> as an <span class=\"process-math\">\\(\\R[x]\\)<\/span>.",
  "body": " Socle and radical of as an   Let be an -module. We calculate the socle and the radical of . By the correspondence theorem, submodules of are submodules of containing . Note that the only such submodules are , , and . Thus, the only proper nontrivial submodule of is . As is simple, we have . Also, is the only simple submodule of and hence, .  More generally, for , let be an -module. Then, by similar arguments as above, we have and .   "
},
{
...
},
{
  ...
  "number": "4.2.3",
  "title": "",
  "body": " Let . Suppose that is such that . By , we have that . Since and is simple, we have . Thus, (2) implies (3).  Suppose that there is an element such that . By , we have , so . Thus, (3) implies (1).  "
},
{
