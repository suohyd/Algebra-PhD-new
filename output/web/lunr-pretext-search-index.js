...
{
  "id": "sec-simple-algebras-18",
  "level": "2",
  "url": "sec-simple-algebras.html#sec-simple-algebras-18",
  "type": "Checkpoint",
  "number": "4.4.8",
  "title": "",
...
},
{
  ...
  "number": "4.6.1",
  "title": "",
  "body": " Suppose that is semisimple. As is generated by we have that , where are simple -modules, i.e., are minimal right ideals of , and (see ). Thus, with each is a direct sum of copies of a minimal right ideals , and for . We claim that for . Indeed, let . We have with and with . As is simple -module, either or . Suppose that By , there exists such that . This implies that Hence, and thus, , a contradiction. This shows that for every , and hence our claim is proved. Therefore,   Suppose that .  "
},
{
  "id": "backmatter-2",
  "level": "1",
